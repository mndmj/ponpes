...
(7, 'Rp.3.000.000 s/d Rp.3.500.000'),
(8, 'Rp.3.500.000 s/d Rp.4.000.000'),
(9, '> Rp.4.000.000');
...
CREATE TABLE `tbl_siswa` (
  ...
  `umur_ayah` int(2) DEFAULT NULL,
  `no_telpon_ayah` varchar(15) DEFAULT NULL,
...
--
ALTER TABLE `tbl_pekerjaan`
  MODIFY `id_pekerjaan` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `tbl_penghasilan`
  MODIFY `id_penghasilan` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
