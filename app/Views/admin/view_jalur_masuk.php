                ...
                <tbody>
                    ...
                    foreach ($jalurmasuk as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?= $value['kuota'] ?></td>
                            <td>
                                <button class="btn btn-xs btn-flat btn-warning" data-toggle="modal" data-target="#edit<?= $value['id_jalur_masuk'] ?>">
                                    <i class="fas fa-pen"></i>
                                </button>
                                <button class="btn btn-xs btn-flat btn-danger" data-toggle="modal" data-target="#delete<?= $value['id_jalur_masuk'] ?>">
    ...
    <div class="modal fade" id="edit<?= $value['id_jalur_masuk'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?= form_open('jalurmasuk/editData/' . $value['id_jalur_masuk']) ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Jalur Masuk</label>
    ...
    <div class="modal fade" id="delete<?= $value['id_jalur_masuk'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Tutup</button>
                    <a href="<?= base_url('jalurmasuk/deleteData/' . $value['id_jalur_masuk']) ?>" class="btn btn-danger btn-sm">Hapus</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
