                ...
                <tbody>
                    ...
                    foreach ($penghasilan as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-xs btn-flat btn-warning" data-toggle="modal" data-target="#edit<?= $value['id_penghasilan'] ?>">
                                    <i class="fas fa-pen"></i>
                                </button>
                                <button class="btn btn-xs btn-flat btn-danger" data-toggle="modal" data-target="#delete<?= $value['id_penghasilan'] ?>">
    ...
    <div class="modal fade" id="edit<?= $value['id_penghasilan'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?= form_open('penghasilan/editData/' . $value['id_penghasilan']) ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Penghasilan</label>
    ...
    <div class="modal fade" id="delete<?= $value['id_penghasilan'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Tutup</button>
                    <a href="<?= base_url('penghasilan/deleteData/' . $value['id_penghasilan']) ?>" class="btn btn-danger btn-sm">Hapus</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
