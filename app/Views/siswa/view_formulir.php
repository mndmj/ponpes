...
<?php if (isset($ta['status']) == 1) {
    ...
    <?php } elseif ($siswa['stat_ppdb'] == 1) { ?>
        <div class="col-sm-12">
            <div class="text-center">
                <div class="alert bg-lightblue p-5">
                    <h1 class="text-bold">**SELAMAT ANDA DITERIMA**</h1>
                    Silahkan cetak bukti kelulusan Anda <a href="<?= base_url('siswa/buktiLulus') ?>" target="_blank">disini.</a>
                </div>
            </div>
        </div>
    ...
    <?php } else { ?>
        <div class="col-sm-12">
            <div class="text-center">
                <div class="alert bg-dark p-5">
                    <h1 class="text-bold">**MAAF ANDA TIDAK DITERIMA**</h1>
                    Tetap semangat !! Silahkan melakukan pendaftaran kembali pada tahun ajaran berikutnya.
                </div>
            </div>
        </div>
    <?php } ?>
